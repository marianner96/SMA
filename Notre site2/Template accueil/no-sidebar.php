			...
			<!-- Header -->
				<div id="header-wrapper">
					<div id="header" class="container">
						...
						<!-- Logo -->
							<h1 id="logo">Théorie du chaos</h1>
							<p>Projet de TIPE de deuxième année de classe préparatoire à l'EISTI Pau</p>
			...
			<!-- Main -->
				...
				<div id="features-wrapper">
					<section id="features" class="container">
						<div class="row">
							<div clas="4u 12u(mobile)">
								<section>
									<a href="theorie-du-chaos1.pdf" class="image featured">
										<img src="image3.jpg" width="100px;" height="100px;" alt></img>
									</a>
									<header>
							...
							<div class="4u 12u(mobile)">
								<section>
									<a href="cahier-des-charges.pdf" class="image featured">
										<img src="image2.jpg" width="100px;" height="150px;" alt></img>
									</a>
									<header>
